...
void Game2D_Layer::OnUpdate(GE::TimeStep ts)
{
...

	{
		...
		//Blue Diamond
		GE::Renderer2D::DrawQuad({ m_SquadPos.x + 1,m_SquadPos.y + 1 }, { 1.0f, 1.0f },0.0f, { 0.1f,0.5f,1.0f,1.0f });

		//Tree Texture
		GE::Renderer2D::DrawQuad({ m_SquadPos.x,m_SquadPos.y + 1.0f, 0.1f }, { 1.0f, 1.0f }, 0.0f,m_Texture2DExample, { 0.5,0.5,1.0,1.0 }, 10.0f);
